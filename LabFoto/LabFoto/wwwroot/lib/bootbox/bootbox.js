...
(function (root, factory) {
  ...
  exports.removeLocale = function (name) {
    if (name !== 'pt') {
      ...
      throw new Error('"pt" é utilizado por defeito e não consegue-se proceder.');
    }
  ...
  //  Get localized text from a locale. Defaults to 'pt' locale if no locale 
